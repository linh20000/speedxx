...
<div class="card">
    <div class="card-header">
        ...
        <div class="dt-buttons btn-group">
            <a href="{{route('admin.createProduct')}}" class="btn btn-secondary action-item" tabindex="0" aria-controls="table-categories">
                <span>
                    ...
                    <tr id="row" class="text-center">
                        ...
                        <td >
                            <div style="height:70px; overflow:hidden; display:flex; justify-content: center">
                                <img style="width:85%; object-fit:cover;" src="{{$item->thumbnail_1 ? asset($item->thumbnail_1) : asset('upload_thumbnail/empty_img.png')}}" alt="">
                            </div>
                        </td>
                        <td> 
                            <a style="word-wrap: break-word;white-space: normal;overflow: hidden;display: -webkit-box;text-overflow: ellipsis;-webkit-box-orient: vertical;-webkit-line-clamp: 2; ">
