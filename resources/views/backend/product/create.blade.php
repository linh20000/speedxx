                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mt-1 mb-1">
                                                        ...
                                                        <input type="text" id="subname" name="subname" value="{{old('subname')}}" class="form-control" placeholder="Nhập tiêu đề">
                                                        @error('subname')
                                                        <span class="text-danger mt-1 d-block">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mt-1 mb-1">
                                                        ...
                                                        <input type="text" id="brand" name="brand" value="{{old('brand')}}" class="form-control" placeholder="Nhập tên">
                                                        @error('brand')
                                                        <span class="text-danger mt-1 d-block">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" id="quantity" name="quantity" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" value="{{old('quantity')}}" class="form-control" placeholder="Nhập Số lượng">
                                                        @error('quantity')
                                                        <span class="text-danger mt-1 d-block">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                             ...
                                             <div class="form-group mt-1 mb-1">
                                                ...
                                                <input type="number" id="old_price" name="old_price" oninput="this.value = this.value.replace(/[^0-9.]/g, '')" value="{{old('old_price')}}" class="form-control" placeholder="Nhập giá gốc">
                                                @error('old_price')
                                                <span class="text-danger mt-1 d-block">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="form-group mt-1 mb-1">
                                                ...
                                                <input type="number" id="off" name="off"  oninput="this.value = this.value.replace(/[^0-9.]/g, '')" min="0" max="100" value="{{old('off')}}" class="form-control" placeholder="Nhập phần trăm giảm giá ">
                                                @error('off')
                                                <span class="text-danger mt-1 d-block">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="form-group mt-1 mb-1">
                                                ...
                                                <input type="text" id="sale_price" name="sale_price" value="{{old('sale_price')}}"  oninput="this.value = this.value.replace(/[^0-9.]/g, '')" class="form-control" placeholder="Bạn cũng có thể nhập giá hiện tại tại đây!">
                                                @error('sale_price')
                                                <span class="text-danger mt-1 d-block">{{ $message }}</span>
                                                @enderror
                                            </div>
                                             <div class="form-group mt-1 mb-1">
                                                ...
                                                @include('backend.product.input_color')
                                                @error('color')
                                                <span class="text-danger mt-1 d-block">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="form-group mt-1 mb-1">
                                                ...
                                                @include('backend.product.input_size')
                                                @error('size')
                                                <span class="text-danger mt-1 d-block">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            <div class="form-group mt-1 mb-1">
                                                ...
                                                @include('backend.product.input_thumbnail')
                                            ...
                                            <div class="row">
                                             ...
                                             <div class="form-group mt-1 mb-1">
                                                ...
                                                <textarea class="form-control" id="summary-ckeditor-description" name="description"></textarea>
                                                @error('description')
                                                <span class="text-danger mt-1 d-block">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <input type="hidden" name="thumbnail_1"  value="">
                                            <input type="hidden" name="thumbnail_2"  value="">
                                        </div>
                                        <!-- /.card-body -->
                                    </div>
                                    <!-- /.card -->
