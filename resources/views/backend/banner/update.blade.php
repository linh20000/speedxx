                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="form-group mt-1 mb-1">
                                        ...
                                        <input type="text" id="title" name="title" value="{{$banner->title}}" class="form-control" placeholder="Nhập tên">
                                        @error('title')
                                    ...
                                    <div class="form-group mt-1 mb-1">
                                        ...
                                        <input type="text" id="header" name="header" value="{{$banner->header}}" class="form-control" placeholder="Nhập tên">
                                        @error('header')
                                        <span class="text-danger mt-1 d-block">{{ $message }}</span>
                                        @enderror
                                    </div>
            ...
            <div class="card-body">
                <div id="imgList" 
                    style="
                        ...
                        margin-bottom: 20px;
                    ">
                    <img style="width:100%; height:100%; border-radius:50%; object-fit:cover;" id="thumbnail_prev" src="{{$banner->thumbnail ? asset($banner->thumbnail) : asset('empty/empty_img.png')}}"  alt="..">
                </div>
